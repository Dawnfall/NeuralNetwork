...
private:
	...
	static void Test_Equality()
	{
		...
		{ 3.0f, 2.0f, 0.4f, -0.7f, -0.3f, -0.6, -0.2f, 0.9f, -0.2f, 0.1f, -0.3f, 1.0f, 3.0f, 0.5f, -0.1f, 0.3f, 0.4f };
		std::vector<float> nn2
		{ 3.0f, 2.0f, 0.4f, -0.7f, -0.3f, -0.6, -0.2f, 0.9f, -0.2f, 0.1f, -0.3f, 1.0f, 3.0f, 0.5f, -0.1f, 0.3f, 0.4f };
		std::vector<float> nn3
		{ 3.0f, 2.0f, 0.4f, -0.7f, -0.3f, -0.6, -0.237188f, 0.9f, -0.2f, 0.1f, -0.3f, 1.0f, 3.0f, 0.489658f, -0.1f, 0.3f, 0.4f };
...
// Duplicate Test
	...
	static void Test_Export()
	{
		...
		std::vector<float> expectedResult{ 3.0f,2.0f,0.4f,-0.7f,-0.3f,-0.6,-0.2f,0.9f,-0.2f,0.1f,-0.3f,1.0f,3.0f,0.5f,-0.1f,0.3f,0.4f };
	...
	static void Test_CrossOver()
	{
		...
		{ 3.0f,2.0f,-1.0f,-1.1f,-1.2f,-1.3,-1.4f,-1.5f,-1.6f,-1.7f,-1.8f,1.0f,3.0f,-1.9f,-2.0f,-2.1f,-2.2f };

		std::vector<float> nnAsData2
		{ 3.0f,2.0f,3.0f,3.1f,3.2f,3.3,3.4f,3.5f,3.6f,3.7f,3.8f,1.0f,3.0f,3.9f,4.0f,4.1f,4.2f };
